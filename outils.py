...
LISTE_PIOCHE_CARTE_SPECIALE = [POUVOIR_ROUTES_GRATUITES, POUVOIR_ROUTES_GRATUITES, POUVOIR_MONOPOLE, POUVOIR_MONOPOLE, POUVOIR_RESSOURCES_GRATUITES, POUVOIR_RESSOURCES_GRATUITES]
for i in range(14):
    LISTE_PIOCHE_CARTE_SPECIALE.append(POUVOIR_CHEVALIER)
for i in range(5):
    LISTE_PIOCHE_CARTE_SPECIALE.append(POUVOIR_POINT_VICTOIRE)
